...
[[cancel-enrollment-unauthorized-fail]]
=== 수강 신청 취소 : 접근 권한 오류

==== HTTP Request

include::{snippets}/cancel-enrollment-unauthorized-fail/http-request.adoc[]

==== HTTP Response

include::{snippets}/cancel-enrollment-unauthorized-fail/http-response.adoc[]
include::{snippets}/cancel-enrollment-unauthorized-fail/response-fields.adoc[]
